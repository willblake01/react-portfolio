...
// EXTERNAL MODULE: ./node_modules.nosync/next/app.js
var app = __webpack_require__("vJht");
...
}), __jsx("title", null, "React Portfolio"));
...
class Page_Page extends external_react_["Component"] {
  render() {
    return Page_jsx(external_styled_components_["ThemeProvider"], {
      theme: theme
    }, Page_jsx(StyledPage, null, Page_jsx(components_Meta, null), Page_jsx(Inner, null, this.props.children)));
  }
...
module.exports = __webpack_require__("kyT2")
