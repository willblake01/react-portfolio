...
var SdlExpect = /** @class */ (function () {
    ...
    SdlExpect.field = function (candidate, name, required, list, type, isId, isReadOnly, defaultValue) {
        ...
        if (fieldObj === undefined) {
            gqlAssert_1.default.raise("Field " + name + " not found. Existing fields: " + candidate.fields.map(function (f) { return f.name; }).join(', '));
        }
    ...
    SdlExpect.type = function (types, name, isEnum, isEmbedded) {
        ...
        if (type === undefined) {
            gqlAssert_1.default.raise("Type " + name + " not found. Existing types: " + types.map(function (t) { return t.name; }).join(', '));
        }
    ...
    SdlExpect.directive = function (obj, target) {
        ...
        if (obj.directives !== undefined) {
            ...
            if (directive === undefined) {
                gqlAssert_1.default.raise("Directive " + target.name + " not found. Existing directives: " + obj.directives.map(function (d) { return d.name; }).join(', '));
            }
