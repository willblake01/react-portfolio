...
var relationalParser_1 = require("../parser/relationalParser");
...
var RelationalRenderer = /** @class */ (function (_super) {
    ...
    RelationalRenderer.prototype.renderField = function (field) {
        if (field.isId && field.name !== relationalParser_1.idFieldName) {
            gqlAssert_1.default.raise("ID field must be called \"" + relationalParser_1.idFieldName + "\" in relational models.");
        }
        if (field.isCreatedAt && field.name !== relationalParser_1.createdAtFieldName) {
            gqlAssert_1.default.raise("CreatedAt field must be called \"" + relationalParser_1.createdAtFieldName + "\" in relational models.");
        }
        if (field.isUpdatedAt && field.name !== relationalParser_1.updatedAtFieldName) {
            gqlAssert_1.default.raise("UpdatedAt field must be called \"" + relationalParser_1.updatedAtFieldName + "\" in relational models.");
        }
