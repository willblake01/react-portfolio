...
var Renderer = /** @class */ (function () {
    ...
    Renderer.prototype.createDatabaseNameTypeDirective = function (type) {
        return { name: directives_1.DirectiveKeys.db, arguments: { name: this.renderValue(scalar_1.TypeIdentifiers.string, type.databaseName) } };
    };
    ...
    Renderer.prototype.createDefaultValueFieldDirective = function (field) {
        return { name: directives_1.DirectiveKeys.default, arguments: { value: this.renderValue(field.type, field.defaultValue) } };
    };
    ...
    Renderer.prototype.createRelationNameFieldDirective = function (field) {
        return { name: directives_1.DirectiveKeys.relation, arguments: { name: this.renderValue(scalar_1.TypeIdentifiers.string, field.relationName) } };
    };
    Renderer.prototype.createIsIdfFieldDirective = function (field) {
        return { name: directives_1.DirectiveKeys.isId, arguments: {} };
    };
    ...
    Renderer.prototype.createDatabaseNameFieldDirective = function (field) {
        return { name: directives_1.DirectiveKeys.db, arguments: { name: this.renderValue(scalar_1.TypeIdentifiers.string, field.databaseName) } };
    };
