...
var Parser = /** @class */ (function () {
     ...
     * @param field
     */
    Parser.prototype.isReservedReadOnlyField = function (field) {
     ...
     * @param field
     */
    Parser.prototype.getDatabaseName = function (fieldOrType) {
     ...
     */
    Parser.prototype.getReservedDirectiveNames = function () {
        return [directives_1.DirectiveKeys.default, directives_1.DirectiveKeys.isEmbedded, directives_1.DirectiveKeys.db, directives_1.DirectiveKeys.isCreatedAt, directives_1.DirectiveKeys.isUpdatedAt, directives_1.DirectiveKeys.isUnique, directives_1.DirectiveKeys.isId];
    };
    /**
     * Parses all directives that are not reserved (build-in)
     * from a field or type
     */
    Parser.prototype.parseDirectives = function (fieldOrType) {
        var res = [];
    ...
    Parser.prototype.parseField = function (field) {
        ...
        var databaseName = this.getDatabaseName(field) || undefined;
    ...
    Parser.prototype.parseObjectType = function (type) {
        ...
        var databaseName = this.getDatabaseName(type) || undefined;
