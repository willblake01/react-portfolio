...
var EndpointDialog = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.isClusterOnline('http://localhost:4466')];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 24:
                        if (!(credentials && credentials.alreadyData && schemas && schemas.length > 0)) return [3 /*break*/, 28];
                    ...
                    case 32:
                        ...
                        if (!result_1.workspace) {
                            ...
                            cluster = clusters.find(function (c) { return c.name === result_1.cluster && c.workspaceSlug === result_1.workspace; });
    ...
    EndpointDialog.prototype.getClusterQuestion = function (fromScratch, hasDockerComposeYml, clusters, isAuthenticated) {
        ...
        if (fromScratch && !hasDockerComposeYml) {
            ...
            var clusterChoices = clusters.length > 0 ? clusters.filter(function (c) { return !c.shared; }).map(this.getClusterChoice) : sandboxChoices;
            var rawChoices = [
                ['Use existing database', 'Connect to existing database'],
                ['Create new database', 'Set up a local database using Docker']
                    ...
                    case 0:
                        question = {
                            ...
                            validate: defaultValue || !required
                                ? undefined
                                : validate || (function (value) { return (value && value.length > 0 ? true : "Please provide a valid " + key); }),
                        };
                        return [4 /*yield*/, this.out.prompt(question)];
                    case 1:
                        result = _c.sent();
