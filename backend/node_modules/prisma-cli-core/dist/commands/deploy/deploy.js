...
var Deploy = /** @class */ (function (_super) {
    ...
    Deploy.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var force, interactive, envFile, dryRun, noMigrate, serviceName, stage, workspace, cluster, dockerComposeYml, endpointDialog, results, _a, projectNew;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 10];
                    case 8: return [4 /*yield*/, this.definition.getCluster(false)];
                    case 9:
                        cluster = _b.sent();
                        _b.label = 10;
                    case 10:
                    ...
                    case 17:
                        ...
                        projectNew = true;
                        _b.label = 18;
                    case 18: return [4 /*yield*/, this.deploy(stage, serviceName, cluster, cluster.name, force, dryRun, projectNew, workspace, noMigrate)];
                    case 19:
                        _b.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(migrationResult.migration && migrationResult.migration.revision > 0 && !dryRun)) return [3 /*break*/, 6];
                        before = Date.now();
                    ...
                    case 6:
                        ...
                        if (!(this.definition.definition.seed && !this.flags['no-seed'] && projectNew)) return [3 /*break*/, 8];
                        this.printHooks();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        before = Date.now();
                        seedSource = this.definition.definition.seed.import || this.definition.definition.seed.run;
                        if (!seedSource) {
    ...
    Deploy.prototype.getLoggedInChoices = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.env.fetchClusters()];
                    case 1:
                        _a.sent();
