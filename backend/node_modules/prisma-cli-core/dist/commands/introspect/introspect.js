...
var IntrospectCommand = /** @class */ (function (_super) {
    ...
    IntrospectCommand.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var interactive, pgHost, pgPort, pgUser, pgPassword, pgDb, pgSsl, pgSchema, mongoUri, mongoDb, endpointDialog, client, connector, databaseType, requiredPostgresArgs, pgArgsEntries, notProvidedArgs, service, stage, cluster, workspace, credentials, schemas, before, e_1, schema, exists, schemaName, exists, _a, ParserInstance, datamodel, introspection, sdl, numTables, renderedSdl, fileName, fullFileName;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!!interactive) return [3 /*break*/, 7];
                    ...
                    case 6:
                        ...
                        _b.label = 7;
                    case 7:
                        if (!(!client || !connector)) return [3 /*break*/, 11];
                        return [4 /*yield*/, endpointDialog.getDatabase(true)];
                    case 8:
                        credentials = _b.sent();
                        if (!(credentials.type === 'postgres')) return [3 /*break*/, 9];
                        client = new pg_1.Client(credentials);
                        connector = new prisma_db_introspection_1.PostgresConnector(client);
                        databaseType = prisma_datamodel_1.DatabaseType.postgres;
                        return [3 /*break*/, 11];
                    case 9:
                        if (!(credentials.type === 'mongo')) return [3 /*break*/, 11];
                    ...
                    case 15:
                        if (!(schemas && schemas.length > 0)) return [3 /*break*/, 31];
                        schema = void 0;
                        if (!(schemas.length === 1)) return [3 /*break*/, 16];
                        schema = schemas[0];
                        return [3 /*break*/, 22];
                    case 16:
                        if (!pgSchema) return [3 /*break*/, 17];
                    ...
                    case 18:
                        ...
                        _a = schemaName;
                        return [3 /*break*/, 21];
                    case 19: return [4 /*yield*/, endpointDialog.selectSchema(schemas.filter(function (s) { return !s.startsWith('prisma-temporary-introspection-service$'); }))];
                    case 20:
                        _a = _b.sent();
                        _b.label = 21;
                    case 21:
                    ...
                    case 24:
                        ...
                        if (!(typeof client.close === 'function')) return [3 /*break*/, 26];
                    ...
                    case 28:
                        ...
                        if (!(!this.definition.definition || !this.definition.definition.datamodel)) return [3 /*break*/, 30];
                        return [4 /*yield*/, this.definition.load(this.flags)];
                    case 29:
                        _b.sent();
                    ...
                    case 31: throw new Error("Could not find schema in provided database.");
