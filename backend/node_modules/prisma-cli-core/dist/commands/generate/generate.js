                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!(this.definition.definition &&
                            ...
                            this.definition.definition.generate.length > 0)) return [3 /*break*/, 23];
                        before = Date.now();
                        schemaString = void 0;
                    ...
                    case 6:
                        ...
                        _c.label = 7;
                    case 7:
                        databaseType = this.definition.definition.databaseType === 'document' ? prisma_datamodel_1.DatabaseType.mongo : prisma_datamodel_1.DatabaseType.postgres;
                    ...
                    case 10:
                        ...
                        _i = 0, _a = this.definition.definition.generate;
                        _c.label = 11;
                    case 11:
                        if (!(_i < _a.length)) return [3 /*break*/, 23];
                        _b = _a[_i], generator = _b.generator, output = _b.output;
                        resolvedOutput = output.startsWith('/') ? output : path.join(this.config.definitionDir, output);
                    ...
                    case 12:
                        ...
                        _c.label = 13;
                    case 13:
                        isMongo = this.definition.definition && this.definition.definition.databaseType === 'document';
    ...
    GenereateCommand.prototype.generateJavascript = function (output, schemaString, internalTypes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                typeDefs = generatorTS.renderTypedefs().replace('export const typeDefs = ', '');
    ...
    GenereateCommand.prototype.generateGo = function (output, schemaString, internalTypes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                secret = this.definition.rawJson.secret ? prisma_client_lib_1.GoGenerator.replaceEnv(this.definition.rawJson.secret) : null;
                options = { endpoint: endpoint };
                if (secret) {
                    options.secret = secret;
                }
    ...
    GenereateCommand.prototype.generateFlow = function (output, schemaString, internalTypes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                secret = this.definition.rawJson.secret ? prisma_client_lib_1.FlowGenerator.replaceEnv(this.definition.rawJson.secret) : null;
                options = { endpoint: endpoint };
                if (secret) {
                    options.secret = secret;
                }
