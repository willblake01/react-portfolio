...
var Client = /** @class */ (function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                ...
                                if (!(e_2.response.errors[0].code === 3016 && e_2.response.errors[0].message.includes('management$default'))) return [3 /*break*/, 5];
                                // TODO: make url mutable in graphql client
                                ;
                                this.clusterClient.url = this.clusterClient.url.replace(/management$/, 'cluster');
                                return [4 /*yield*/, this.clusterClient.request(query, variables)];
                            case 4:
                                result = _a.sent();
                                debug(result);
                                return [2 /*return*/, result];
                            case 5:
                                if (!(e_2.message.includes('HTTP method not allowed') && this.clusterClient.url.endsWith('management'))) return [3 /*break*/, 7];
                                // TODO: make url mutable in graphql client
                                ;
                                this.clusterClient.url = this.clusterClient.url.replace(/management$/, 'cluster');
                                return [4 /*yield*/, this.clusterClient.request(query, variables)];
    ...
    Client.prototype.reset = function (serviceName, stage, token, workspaceSlug) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = this.env.activeCluster.getApiEndpoint(serviceName, stage, workspaceSlug) + '/private';
                        return [4 /*yield*/, fetch(endpoint, {
                                method: 'post',
                                headers: {
                                    Authorization: "Bearer " + token,
    ...
    Client.prototype.deploy = function (name, stage, types, dryRun, subscriptions, secrets, force, noMigration) {
        return __awaiter(this, void 0, void 0, function () {
            var oldMutation, introspectionResult, hasStepsApi, steps, noMigrationInput, newMutation, deploy, e_4, deploy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (noMigration && !graphql_schema_1.hasTypeWithField(introspectionResult, 'DeployInput', 'noMigration')) {
